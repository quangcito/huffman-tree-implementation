...
class BST:
    ...
    def postorderTraverse(self, nodeFn = None):
        ...
        if self.isEmpty():
            ...
            # recur on left and right children, if they exist
            if self.hasLeftChild():
                self.leftChild.postorderTraverse(nodeFn)
            if self.hasRightChild():
                self.rightChild.postorderTraverse(nodeFn)
    ...
    def inorderTraverse(self, nodeFn = None):
        ...
        if self.isEmpty():
            ...
            # recur on left and right children, if they exist
            if self.hasLeftChild():
                self.leftChild.inorderTraverse(nodeFn)
            ...
            if self.hasRightChild():
                self.rightChild.inorderTraverse(nodeFn)
    ...
    def insert(self, newValue):
        ...
        if self.isEmpty():
            ...
            if self.hasRightChild():
                self.setRightChild(self.getRightChild().insert(newValue))
            else:
                self.setRightChild(BST(newValue))
        elif self.nodeValue > newValue:
            if self.hasLeftChild():
                self.setLeftChild(self.getLeftChild().insert(newValue))
            else:
